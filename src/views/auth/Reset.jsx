...
function Reset() {
  ...
  return (
    <Center>
      <Card>
        <Heading as={2}>{t("actions.resetting_password")}</Heading>

        <p>{t("actions.resetting_password_instructions")}</p>
        ...
        <Button variant="success" onClick={() => sendPasswordResetEmail(email)}>
          {t("actions.reset")}
        </Button>
